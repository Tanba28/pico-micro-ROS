...
#include <stddef.h>
#include "qtw_interfaces/msg/detail/target__rosidl_typesupport_introspection_c.h"
...
#include "qtw_interfaces/msg/detail/target__struct.h"
...
void qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  qtw_interfaces__msg__Target__init(message_memory);
}

void qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_fini_function(void * message_memory)
{
...
static rosidl_typesupport_introspection_c__MessageMember qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_message_member_array[8] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(qtw_interfaces__msg__Target, value_1),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(qtw_interfaces__msg__Target, value_2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(qtw_interfaces__msg__Target, value_3),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(qtw_interfaces__msg__Target, value_4),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_message_members = {
  ...
  qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_message_type_support_handle = {
  0,
  &qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qtw_interfaces, msg, Target)() {
  ...
  return &qtw_interfaces__msg__Target__rosidl_typesupport_introspection_c__Target_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
